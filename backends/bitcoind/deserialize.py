...
class BCDataStream(object):
    """Workalike python implementation of AsicCoin's CDataStream class."""
    def __init__(self):
        self.input = None
        self.read_cursor = 0
    ...
    def read_string(self):
        ...
        # ... and the AsicCoin client is coded to understand:
...
# This function comes from asiccointools, bct-LICENSE.txt.
def long_hex(bytes):
...
def get_address_from_output_script(bytes):
    ...
    # Pay-by-AsicCoin-address TxOuts look like:
    # DUP HASH160 20 BYTES:... EQUALVERIFY CHECKSIG
